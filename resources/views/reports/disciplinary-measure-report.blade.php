...
<body>
    <div class="action-buttons">
        ...
        <a href="{{ route('hr.disciplinary-measure-report.pdf', $measure->id) }}" class="action-btn pdf-btn">
    ...
    <div class="container">
        ...
        {{-- Título do Documento --}}
        <div class="document-title" data-i18n="disciplinary_measure_form">
        ...
        <div class="measure-details">
            <h3 data-i18n="measure_details">{{ __('messages.measure_details') }}</h3>
        ...
        {{-- Motivo --}}
        <div class="info-section">
            <h3><i class="fas fa-exclamation-triangle"></i> {{ __('messages.reason') }}</h3>
            <p>{{ $measure->reason }}</p>
        </div>

        {{-- Descrição --}}
        <div class="description-section">
            <h4><i class="fas fa-file-alt"></i> {{ __('messages.description') }}</h4>
        ...
        <div class="signatures">
            <div class="signature-box">
                <div class="signature-line">
                    ...
                    <div class="signature-role">{{ __('messages.date') }}: {{ $measure->applied_date->format('d/m/Y') }}</div>
                </div>
            </div>
    ...
    <script>
        ...
        const translations = {
            pt: {
                ...
                'measure_details': 'Detalhes da Medida'
            },
            en: {
                'back': 'Back',
                'print': 'Print',
                'download_pdf': 'Download PDF',
                'disciplinary_measure_form': 'DISCIPLINARY MEASURE NOTIFICATION',
                'employee_information': 'Employee Information',
                'measure_details': 'Measure Details'
            }
        };
