...
<body>
    <div class="container">
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ \Carbon\Carbon::parse($plan->production_date)->format('d/m/Y') }}</td>
                            <td>{{ $plan->shift->name ?? __('messages.not_assigned') }}</td>
                            <td>{{ $plan->responsible->name ?? __('messages.not_assigned') }}</td>
                            <td class="text-right">{{ number_format($plan->planned_quantity, 0, ',', '.') }}</td>
                            <td class="text-right">{{ number_format($plan->actual_quantity, 0, ',', '.') }}</td>
                            <td class="text-right">{{ number_format($plan->efficiency, 1, ',', '.') }}%</td>
                            <td>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ number_format($order->planned_quantity, 0, ',', '.') }}</td>
                            <td class="text-right">{{ number_format($order->produced_quantity, 0, ',', '.') }}</td>
                            <td>
        ...
        <div class="footer">
            <div>{{ __('messages.confidential_document') }} | {{ __('messages.erp_dembena') }} &copy; {{ date('Y') }}</div>
            <div style="margin-top: 5px; font-size: 9px;">
                {{ __('messages.generated_on') }}: {{ $currentDate }} | {{ __('messages.by') }}: {{ $user->name }}
            </div>
        </div>
