        ...
        <div class="relative bg-white rounded-xl shadow-2xl transform transition-all duration-300 ease-in-out" 
            ...
            <div class="bg-gray-50 px-6 py-4 rounded-b-xl flex justify-between items-center border-t border-gray-200">
                <div class="flex space-x-3">
                    ...
                    @if($selectedTransferRequest)
                        <button type="button" 
                                wire:click="generatePdf({{ $selectedTransferRequest->id }})" 
                                wire:loading.attr="disabled" 
                                class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-lg font-semibold text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200 ease-in-out transform hover:scale-105">
                            <span wire:loading.remove wire:target="generatePdf">
                                <i class="fas fa-file-pdf mr-2"></i>
                                {{ __('Exportar PDF') }}
                            </span>
                            <span wire:loading wire:target="generatePdf" class="inline-flex items-center">
