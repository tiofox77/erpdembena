<!-- Modal para Confirmar Exclusão de Plano de Capacidade -->
<div x-cloak
    ...
    <div class="relative w-full max-w-md mx-auto my-8 px-4 sm:px-0"
        ...
        <div class="relative bg-white rounded-lg shadow-xl overflow-hidden" @click.stop>
            ...
            <div class="p-6">
                <div class="mb-4 flex flex-col items-center justify-center text-center space-y-4">
                    <div class="flex-shrink-0 bg-red-100 p-3 rounded-full">
                        <i class="fas fa-trash text-red-600 text-2xl"></i>
                    </div>
                    <h3 class="text-lg font-medium text-gray-900">{{ __('messages.delete_capacity_plan') }}</h3>
                    <p class="text-sm text-gray-500">
                        {{ __('messages.delete_capacity_plan_confirmation') }}
                    </p>
                    <p class="text-sm text-red-600 font-medium">
                        {{ __('messages.delete_capacity_plan_warning') }}
                    </p>
                </div>
                
                <!-- Informações sobre rascunho e cancelamento -->
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>
                                    {{ __('messages.delete_only_draft_cancelled') }}
                                </p>
                            </div>
                        </div>
                    </div>
