<!-- Modal para Confirmar Exclusão de Plano de Compra -->
<div x-cloak
        ...
        <div class="relative bg-white rounded-lg shadow-xl overflow-hidden" @click.stop>
            ...
            <div class="p-6">
                <div class="flex flex-col items-center justify-center text-center space-y-4">
                    ...
                    <h3 class="text-lg font-medium text-gray-900">{{ __('messages.delete_purchase_plan') }}</h3>
                    <p class="text-sm text-gray-500">
                        {{ __('messages.delete_purchase_plan_confirmation') }}
                    </p>
                ...
                <!-- Informações sobre status planejado e cancelado -->
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>
                                    {{ __('messages.delete_purchase_plan_status_condition') }}
                                </p>
                            </div>
                        </div>
                    </div>
