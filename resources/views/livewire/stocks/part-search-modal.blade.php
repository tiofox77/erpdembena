                ...
                <div class="p-6">
                    ...
                    <div class="border border-gray-200 rounded-md overflow-hidden">
                        <div class="max-h-96 overflow-y-auto">
                            @forelse($this->partsForEquipment as $part)
                                <div class="px-4 py-3 hover:bg-blue-50 cursor-pointer transition-colors duration-150 border-b border-gray-100 last:border-0"
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            @if($part->unit_cost)
                                                <p class="text-xs text-blue-700 mt-1">
                                                    ...
                                                    Unit Cost: ${{ number_format($part->unit_cost, 2) }}
                                                </p>
                                            @endif
                                        </div>
