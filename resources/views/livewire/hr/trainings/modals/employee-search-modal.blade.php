    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 max-h-[80vh] overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-purple-100">{{ __('messages.search_select_employee_for_training') }}</p>
                    </div>
                </div>
                ...
                <div class="divide-y divide-gray-200">
                    @foreach($employees as $employee)
                        <div wire:click="selectEmployee({{ $employee->id }})" 
                             class="p-4 hover:bg-purple-50 cursor-pointer transition-colors">
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-end border-t border-gray-200">
            <button wire:click="closeEmployeeSearch" 
                    class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors">
                {{ __('messages.cancel') }}
            </button>
        </div>
    </div>
