                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex space-x-3">
                                ...
                                <button type="button"
                                    ...
                                    <span wire:loading.remove wire:target="openImportModal" class="flex items-center">
                                        <i class="fas fa-file-import mr-2"></i>
                                        {{ __('messages.import') }}
                                    </span>
                                    <span wire:loading wire:target="openImportModal" class="flex items-center">
                                                    ...
                                                    @else
                                                        ...
                                                        <div class="flex items-center space-x-3">
                                                            ...
                                                            <button type="button" 
                                                                    ...
                                                                    wire:loading.attr="disabled"
                                                                    wire:target="openImportModal"
                                                                    class="inline-flex items-center px-3 py-2 border border-indigo-300 text-sm font-medium rounded-lg text-indigo-700 bg-indigo-50 hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105">
                                                                <span wire:loading.remove wire:target="openImportModal" class="flex items-center">
                                                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
