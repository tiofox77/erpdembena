                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ $department->manager ? $department->manager->full_name : 'N/A' }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
            ...
            <form wire:submit.prevent="save" class="space-y-4">
                ...
                <div class="flex items-start mt-4">
                    ...
                    <div class="ml-3 text-sm">
                        ...
                        <p class="text-gray-500">Set the department as active or inactive</p>
                    </div>
                </div>
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">
                            Are you sure you want to delete this department? All employees associated with this department will be affected. This action cannot be undone.
                        </p>
                    </div>
                </div>
            </div>
