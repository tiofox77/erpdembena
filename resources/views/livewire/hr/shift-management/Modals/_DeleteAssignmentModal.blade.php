{{-- Modal: DeleteAssignment (DO NOT RENAME) --}}
<div x-data="{ open: @entangle('showDeleteAssignmentModal') }" x-show="open" x-cloak
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="open" x-transition:enter="ease-out duration-300" 
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Tem certeza que deseja excluir a atribuição de turno para <strong>"{{ $assignment_to_delete_name ?? '' }}"</strong>?
                            </p>
                            <p class="text-sm text-gray-500 mt-2">
                                Esta ação não pode ser desfeita. A atribuição será permanentemente removida e o funcionário não terá mais este turno assignado.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button wire:click="confirmDeleteAssignment" type="button"
                ...
                <button wire:click="cancelDeleteAssignment" type="button"
