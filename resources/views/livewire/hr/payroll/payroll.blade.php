            ...
            <div class="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 px-6 py-8 text-white flex-shrink-0">
                <div class="w-full flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold">{{ __('livewire/hr/payroll.payroll_management') }}</h1>
                            <p class="text-blue-100 mt-1">{{ __('livewire/hr/payroll.payroll_management_description') }}</p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-gradient-to-br from-green-50 to-emerald-100 p-6 rounded-xl border border-green-200 hover:shadow-lg transition-all duration-300">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-green-600 font-medium text-sm">{{ __('livewire/hr/payroll.total_processed') }}</p>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200 hover:shadow-lg transition-all duration-300">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-blue-600 font-medium text-sm">{{ __('livewire/hr/payroll.pending_approval') }}</p>
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200 hover:shadow-lg transition-all duration-300">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-purple-600 font-medium text-sm">{{ __('livewire/hr/payroll.approved_status') }}</p>
                    ...
                    <div class="bg-gradient-to-br from-amber-50 to-yellow-100 p-6 rounded-xl border border-amber-200 hover:shadow-lg transition-all duration-300">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-amber-600 font-medium text-sm">{{ __('livewire/hr/payroll.paid_status') }}</p>
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-lg font-semibold text-gray-700 flex items-center">
                            ...
                            {{ __('livewire/hr/payroll.filters_and_search') }}
                        </h3>
                        <button
                        ...
                        >
                            ...
                            <span class="text-sm font-medium">{{ __('livewire/hr/payroll.reset') }}</span>
                        </button>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        <div>
                            <label for="search" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                {{ __('livewire/hr/payroll.search_employee') }}
                            </label>
                            <div class="relative">
                                <input
                                    type="text"
                                    ...
                                    placeholder="{{ __('livewire/hr/payroll.search_employee_placeholder') }}"
                        ...
                        <div>
                            <label for="department_filter" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                {{ __('livewire/hr/payroll.department') }}
                            </label>
                            <select
                            ...
                            >
                                <option value="">{{ __('livewire/hr/payroll.all_departments') }}</option>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                            >
                                <option value="">{{ __('livewire/hr/payroll.all_months') }}</option>
                                @for($i = 1; $i <= 12; $i++)
                                    <option value="{{ $i }}">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                            >
                                <option value="">{{ __('livewire/hr/payroll.all_years') }}</option>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                            >
                                <option value="">{{ __('livewire/hr/payroll.all_status') }}</option>
                                <option value="draft">{{ __('livewire/hr/payroll.draft') }}</option>
                                <option value="approved">{{ __('livewire/hr/payroll.approved_status') }}</option>
                                <option value="paid">{{ __('livewire/hr/payroll.paid_status') }}</option>
                                <option value="cancelled">{{ __('livewire/hr/payroll.cancelled') }}</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex-1 bg-white px-6 py-6">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200 mb-6">
                    <h3 class="text-lg font-semibold text-gray-700 flex items-center mb-4">
                        ...
                        {{ __('livewire/hr/payroll.payroll_records') }}
                    </h3>
                                    ...
                                    <div class="lg:col-span-2">
                                        <div class="space-y-2">
                                            <div class="flex items-center space-x-2 text-sm">
                                                ...
                                                <span class="text-gray-700 font-medium">{{ number_format($payroll->attendance_hours ?? 0, 1) }} {{ __('livewire/hr/payroll.hours') }}</span>
                                            </div>
                                            <div class="flex items-center space-x-2 text-sm">
                                                <div class="w-2 h-2 bg-yellow-400 rounded-full"></div>
                                                <i class="fas fa-calendar-alt text-yellow-500 text-xs"></i>
                                                <span class="text-gray-700">{{ number_format($payroll->leave_days ?? 0, 1) }} {{ __('livewire/hr/payroll.days') }}</span>
                                            </div>
                                            @if(($payroll->maternity_days ?? 0) > 0)
                                                <div class="flex items-center space-x-2 text-xs">
                                                    <i class="fas fa-baby text-pink-500"></i>
                                                    <span class="text-pink-600 font-medium">{{ number_format($payroll->maternity_days ?? 0, 1) }} {{ __('livewire/hr/payroll.maternity') }}</span>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="lg:col-span-4">
                                        <div class="space-y-3">
                                            ...
                                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-3 border border-green-200">
                                                <div class="grid grid-cols-2 gap-3">
                                                    <div class="text-center">
                                                        <p class="text-xs text-green-600 font-medium">{{ __('livewire/hr/payroll.gross') }}</p>
                                                        <p class="text-sm font-bold text-green-700">{{ number_format($payroll->gross_salary, 0) }}</p>
                                                    </div>
                                                    <div class="text-center">
                                                        <p class="text-xs text-green-600 font-medium">{{ __('livewire/hr/payroll.net') }}</p>
                                            ...
                                            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 border border-gray-200">
                                                <div class="text-center">
                                                    <p class="text-xs text-gray-500 font-medium">{{ __('livewire/hr/payroll.salary_hidden') }}</p>
                                                    <p class="text-sm text-gray-600">{{ __('livewire/hr/payroll.processing_only') }}</p>
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            <div class="bg-gradient-to-r from-red-50 to-pink-50 rounded-lg p-3 border border-red-200">
                                                <div class="flex items-center justify-between mb-2">
                                                    <div class="flex items-center space-x-2">
                                                        ...
                                                        <p class="text-xs text-red-700 font-semibold">{{ __('livewire/hr/payroll.detailed_discounts') }}</p>
                                                    </div>
                                                ...
                                                <div class="space-y-1.5">
                                                    ...
                                                    @if($this->canViewSalaryDetails() && $payroll->advance_deduction > 0)
                                                        <div class="flex justify-between items-center text-xs">
                                                            <div class="flex items-center space-x-1.5">
                                                                ...
                                                                <span class="text-gray-700">{{ __('livewire/hr/payroll.salary_advances') }}</span>
                                                            </div>
                                                    ...
                                                    @if($this->canViewSalaryDetails() && $payroll->total_salary_discounts > 0)
                                                        <div class="flex justify-between items-center text-xs">
                                                            <div class="flex items-center space-x-1.5">
                                                                ...
                                                                <span class="text-gray-700">{{ __('livewire/hr/payroll.salary_discounts') }}</span>
                                                            </div>
                                                    ...
                                                    @if($payroll->income_tax > 0)
                                                        <div class="flex justify-between items-center text-xs">
                                                            <div class="flex items-center space-x-1.5">
                                                                ...
                                                                <span class="text-gray-700">{{ __('livewire/hr/payroll.income_tax') }}</span>
                                                            </div>
                                                    ...
                                                    @if($payroll->social_security > 0)
                                                        <div class="flex justify-between items-center text-xs">
                                                            <div class="flex items-center space-x-1.5">
                                                                ...
                                                                <span class="text-gray-700">{{ __('livewire/hr/payroll.social_security') }}</span>
                                                            </div>
                                                    ...
                                                    @if(($payroll->late_deduction ?? 0) > 0 || ($payroll->absence_deduction ?? 0) > 0)
                                                        <div class="flex justify-between items-center text-xs">
                                                            <div class="flex items-center space-x-1.5">
                                                                ...
                                                                <span class="text-gray-700">{{ __('livewire/hr/payroll.attendance_deductions') }}</span>
                                                            </div>
                                                    ...
                                                    @if($payroll->other_deductions > 0)
                                                        <div class="flex justify-between items-center text-xs">
                                                            <div class="flex items-center space-x-1.5">
                                                                ...
                                                                <span class="text-gray-700">{{ __('livewire/hr/payroll.other_deductions') }}</span>
                                                            </div>
                                                    ...
                                                    @if($payroll->total_deductions == 0)
                                                        <div class="text-center py-1">
                                                            <p class="text-xs text-gray-500">{{ __('livewire/hr/payroll.no_discounts') }}</p>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex justify-center">
                                            ...
                                            @elseif($payroll->status === 'approved')
                                                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-blue-100 text-blue-800 border border-blue-200">
                                                    ...
                                                    {{ __('livewire/hr/payroll.approved') }}
                                                </span>
                                            @else
                                        ...
                                        <div class="flex items-center justify-end space-x-2">
                                            <div class="relative group">
                                                ...
                                                <div class="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
                                                    {{ __('livewire/hr/payroll.view_details') }}
                                                </div>
                                            </div>
                                            ...
                                            @if($payroll->status === 'draft')
                                                ...
                                                <div class="relative group">
                                                    ...
                                                    <div class="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
                                                        {{ __('livewire/hr/payroll.approve') }}
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div class="relative group">
                                                ...
                                                <div class="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
                                                    {{ __('livewire/hr/payroll.view_receipt') }}
                                                </div>
                                            </div>
                        ...
                        @empty
                            <div class="text-center py-16">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3">
                                    {{ __('livewire/hr/payroll.no_payroll_found_title') }}
                                </h3>
                                <div class="max-w-md mx-auto">
                                    @if($search || !empty($filters['period_id']) || !empty($filters['department_id']) || !empty($filters['status']))
                                        <p class="text-gray-600 mb-4">
                                            {{ __('livewire/hr/payroll.no_records_match_criteria') }}
                                        </p>
                                        <button wire:click="resetFilters" 
                                            ...
                                            {{ __('livewire/hr/payroll.reset') }}
                                        </button>
                                    @else
                                        <p class="text-gray-600 mb-4">
                                            {{ __('livewire/hr/payroll.no_payroll_records_yet') }}
                                        </p>
                                        <button wire:click="openEmployeeSearch" 
                                            ...
                                            {{ __('livewire/hr/payroll.process_first_payroll') }}
                                        </button>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[95vh] flex flex-col">
                ...
                <div class="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 text-white rounded-t-2xl">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                            ...
                            <div class="min-w-0 flex-1">
                                <h3 class="text-lg sm:text-xl lg:text-2xl font-bold truncate">{{ __('livewire/hr/payroll.payroll_details') }}</h3>
                ...
                <div class="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                        ...
                        <!-- Card {{ __('livewire/hr/payroll.employee') }} -->
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 border border-blue-200">
                            <div class="flex items-center mb-4">
                                ...
                                <h4 class="font-semibold text-gray-800">{{ __('livewire/hr/payroll.employee') }}</h4>
                            </div>
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.name') }}:</span>
                                    <span class="text-sm font-medium text-gray-800">{{ $currentPayroll->employee->full_name }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.id') }}:</span>
                                    <span class="text-sm font-medium text-gray-800">{{ $currentPayroll->employee->id }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.department') }}:</span>
                                    <span class="text-sm font-medium text-gray-800">{{ $currentPayroll->employee->department->name ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.position') }}:</span>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 border border-green-200">
                            <div class="flex items-center mb-4">
                                ...
                                <h4 class="font-semibold text-gray-800">{{ __('livewire/hr/payroll.period') }}</h4>
                            </div>
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.period') }}:</span>
                                    <span class="text-sm font-medium text-gray-800">{{ $currentPayroll->payrollPeriod->name ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.start_date') }}:</span>
                                    <span class="text-sm font-medium text-gray-800">{{ $currentPayroll->payrollPeriod?->start_date?->format('d/m/Y') ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.end_date') }}:</span>
                                    <span class="text-sm font-medium text-gray-800">{{ $currentPayroll->payrollPeriod?->end_date?->format('d/m/Y') ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.hours') }}:</span>
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl p-6 border border-purple-200">
                            <div class="flex items-center mb-4">
                                ...
                                <h4 class="font-semibold text-gray-800">{{ __('livewire/hr/payroll.status') }}</h4>
                            </div>
                            <div class="space-y-2">
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.status') }}:</span>
                                ...
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.created_at') }}:</span>
                                    <span class="text-sm font-medium text-gray-800">{{ $currentPayroll->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.payment') }}:</span>
                                ...
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">{{ __('livewire/hr/payroll.account') }}:</span>
                                ...
                                <div class="space-y-3">
                                    ...
                                    @foreach($currentPayroll->payrollItems->whereIn('type', ['earning', 'allowance', 'bonus']) as $item)
                                        ...
                                        <div class="flex justify-between items-center py-2 border-b border-green-200 last:border-b-0">
                                            ...
                                            <span class="text-sm font-bold text-green-700">{{ number_format((float)$item->amount, 2, ',', '.') }} {{ __('livewire/hr/payroll.currency') }}</span>
                                        </div>
                                    @endforeach
                                    <div class="flex justify-between items-center pt-3 border-t-2 border-green-300">
                                        <span class="font-semibold text-green-800">{{ __('livewire/hr/payroll.total_earnings') }}:</span>
                                        <span class="text-lg font-bold text-green-700">{{ number_format($totalEarnings, 2, ',', '.') }} {{ __('livewire/hr/payroll.currency') }}</span>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center mt-1">
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                                        ...
                                                        {{ $item->type === 'tax' ? __('livewire/hr/payroll.tax') : __('livewire/hr/payroll.deduction') }}
                                                    </span>
                                                </div>
                                            </div>
                                            <span class="text-sm font-bold text-red-700">-{{ number_format(abs((float)$item->amount), 2, ',', '.') }} {{ __('livewire/hr/payroll.currency') }}</span>
                                        </div>
                                    @endforeach
                                    <div class="flex justify-between items-center pt-3 border-t-2 border-red-300">
                                        <span class="font-semibold text-red-800">{{ __('livewire/hr/payroll.total_deductions') }}:</span>
                                        <span class="text-lg font-bold text-red-700">-{{ number_format($totalDeductions, 2, ',', '.') }} {{ __('livewire/hr/payroll.currency') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="text-center">
                                <div class="bg-green-100 rounded-lg p-4">
                                    ...
                                    <p class="text-sm text-gray-600 mb-1">{{ __('payroll.gross_total') }}</p>
                                     <p class="text-xl font-bold text-green-700">{{ number_format((float)$currentPayroll->basic_salary + (float)$currentPayroll->allowances + (float)$currentPayroll->overtime + (float)$currentPayroll->bonuses, 2, ',', '.') }} {{ __('livewire/hr/payroll.currency') }}</p>
                                </div>
                            </div>
                            <div class="text-center">
                                <div class="bg-red-100 rounded-lg p-4">
                                    ...
                                    <p class="text-sm text-gray-600 mb-1">{{ __('payroll.total_deductions') }}</p>
                                     <p class="text-xl font-bold text-red-700">{{ number_format((float)$currentPayroll->tax + (float)$currentPayroll->social_security + (float)$currentPayroll->deductions, 2, ',', '.') }} {{ __('livewire/hr/payroll.currency') }}</p>
                                </div>
                            </div>
                            <div class="text-center">
                                <div class="bg-blue-100 rounded-lg p-4">
                                    ...
                                    <p class="text-sm text-gray-600 mb-1">{{ __('payroll.net_salary') }}</p>
                                     <p class="text-2xl font-bold text-blue-700">{{ number_format((float)$currentPayroll->net_salary, 2, ',', '.') }} {{ __('livewire/hr/payroll.currency') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
