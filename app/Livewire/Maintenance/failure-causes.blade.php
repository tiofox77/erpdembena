                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    {{ $cause->category?->name ?? 'Sem categoria' }}
                                </span>
                            </td>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center">
                                <div class="flex flex-col items-center justify-center py-8">
                                    ...
                                    <p class="text-gray-500 mb-3">No failure causes found</p>
                                    <button wire:click="openCreateModal" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md">
            ...
            <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                    ...
                    <form wire:submit.prevent="save">
                        <div class="mb-4">
                            <label for="cause-category" class="block text-sm font-medium text-gray-700 mb-1">Category</label>
                        ...
                        <div class="mb-4">
                            <label for="cause-name" class="block text-sm font-medium text-gray-700 mb-1">Name</label>
        ...
        @if($showDeleteModal)
            <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                    ...
                    <div class="mb-6">
                        <p class="text-gray-700">Are you sure you want to delete this failure cause? This action cannot be undone.</p>
                    </div>
                    <div class="flex justify-end space-x-2">
